...
const Agenda = ({ img, description }: { img: string; description: string }) => {
  return (
    <div
      className={`flex flex-col flex-1 gap-2 sm:gap-4 justify-content-center text-center px-4 mb-4 md:mb-0`}
    >
...
const Home4 = () => {
  ...
  return (
    <div className="container py-4 sm:py-8">
      <p className="text-primary text-xl sm:text-2xl font-light">
